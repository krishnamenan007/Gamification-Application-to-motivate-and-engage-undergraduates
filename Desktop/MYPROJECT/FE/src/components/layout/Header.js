...
import { signOut, signUp } from "../../redux/action";
 ...
 const dispatch = useDispatch();
  ...
  return (
    <>
      ...
      <Row gutter={[24, 0]} style={{background:"#fff",padding:"20px 0px",borderRadius:"20px"}}>
        <Col span={24} md={6}>
          {/* <Breadcrumb> */}
            {/* <Breadcrumb.Item>
          ...
          <div className="ant-page-header-heading">
            <span
              ...
              style={{ textTransform: "capitalize",color:"#000489",fontWeight:"bolder" }}
            >
              Hey FixIt !
            </span>
          </div>
        ...
        <Col span={24} md={18} className="header-control">
          ...
          <div style={{ cursor: "pointer" ,display:"flex",gap:"0.5rem",alignItems:"center",justifyContent:"center"}} className="btn-sign-in">
            <div style={{height:"40px",width:"40px"}} onClick={() => history.push("/profile")}>{profile}</div>
            <Button danger onClick={signOutFunc}>Sign out</Button>
          </div>
